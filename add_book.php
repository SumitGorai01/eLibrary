			...
			<form action="add_book.php" method="post">
	           ...
	           <div class="form-group">
				...
				<div class="col-md-12 text-center">
				    <button class="btn btn-success " name="add_book">Add Book</button>
...
<?php
	if(isset($_POST['add_book']))
	{
        ...
        mysqli_select_db($conn,"id19345642_library");
    	 mysqli_query($conn,"insert into books values(null,'$_POST[book_name]',$_POST[book_author],$_POST[book_cat],$_POST[book_no],$_POST[book_price],'$_POST[book_pdf]')");
