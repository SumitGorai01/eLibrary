...
Preserving the past, opening the future.</p>
        ...
        <div class="col-md-3 col-sm-6">
          ...
          <ul class="footer-category">
            ...
            <li><a href="#">sumitgr7479@gmail.com</a>
            </li>
...
<td><input type="radio" value="stu" name="a" required>Student</td>
</tr>
</div>
<br>
...
" class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="form-row">
<div class="form-group col-md-12">Enter Name
    ...
    <!--</div>-->
<div class="form-group col-md-6">Date of Birth
...
<div class="form-group col-md-6">Phone Number
