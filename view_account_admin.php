        ...
        <div class="col-md-5 border-right">
            <div class="p-3 py-5">
                ...
                <div class="row mt-6">
                    ...
                    <div class="col-md-6"><label class="labels">ID</label><input type="text" class="form-control" placeholder="<?php echo$rows[0]; ?>" readonly value=""></div>
                    ...
                    <div class="col-md-6"><label class="labels">Name</label><input type="text" class="form-control" placeholder="<?php echo$rows[1]; ?>" readonly value=""></div>
                     ...
                     <div class="col-md-6"><label class="labels">Email ID</label><input type="text" class="form-control" placeholder="<?php echo$rows[2]; ?>" readonly value=""></div>
                     
                     <div class="col-md-6"><label class="labels">Password</label><input type="text" class="form-control" placeholder="<?php echo$rows[3]; ?>" readonly value=""></div>
