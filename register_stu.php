...
<div class="row">
	...
	<div class="col-md-10">
		<form>
			<table class="table-bordered" width="1000px" style="text-align: center">
				<tr>
					<th>Student ID</th>
					<th>Name</th>
					<th>DOB</th>
    ...
    mysqli_select_db($conn,"id19345642_library");
 	$res=mysqli_query($conn,"select student_id,NAME,DOB,GENDER,PHONE,EMAIL,ADDRESS from STU");
