				...
				<div class="form-group">
					...
					<select class="form-control" name="book_author">
						...
						<?php
							...
							$res=mysqli_query($conn,"select author_name from authors");
...
<?php
	if(isset($_POST['issue_book']))
	{
	    $conn=mysqli_connect("localhost","id19345642_lib","8pDyHgtmnXIi|~O[");
        mysqli_select_db($conn,"id19345642_library");
		mysqli_query($conn,"insert into issued_books values(null,$_POST[book_no],'$_POST[book_name]','$_POST[book_author]',$_POST[student_id],1,'$_POST[issue_date]')");
